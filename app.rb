...
any_precipitation = false
  ...
  if precip_prob > precip_prob_threshold
    ...
    precip_time = Time.at(next_hour.fetch("time"))

    seconds_from_now = precip_time - Time.now

    min_from_now = seconds_from_now / 60 

    puts "Next hour: there is chance of rain in #{min_from_now.round} minutes."
  end
